...
function HeroText() {
  return (
    <div className="textContainer text-center text-lg-start">
      <h2>Hello, I'm</h2>
      <h1>Mohamed Mounir</h1>
      <h3>
        A <span>Frontend Developer</span> From <span>Egypt </span>
      </h3>
      <p>
      ...
      <div className="buttonAndIcons">
        ...
        <span className="linkedin mx-3">
          <a href="https://www.linkedin.com/in/mohamed-mounir-b255a9242/">
            <svg
        ...
        <span>
          <a href="https://github.com/mohamedmounir2425">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
